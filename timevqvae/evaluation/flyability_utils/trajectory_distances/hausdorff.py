...
from .basic_spherical import (great_circle_distance,
                              great_circle_distance_traj, point_to_path)
...
def s_hausdorff(t0, t1):
    ...
    t0_dist = [
        great_circle_distance(lons0[it0], lats0[it0], lons0[it0 + 1], lats0[it0 + 1])
        for it0 in range(n0 - 1)
    ]
    t1_dist = [
        great_circle_distance(lons1[it1], lats1[it1], lons1[it1 + 1], lats1[it1 + 1])
        for it1 in range(n1 - 1)
    ]
