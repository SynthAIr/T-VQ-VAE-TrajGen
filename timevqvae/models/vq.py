...
def softmax_sample(t, temperature=1.0, dim=-1):
    if temperature == 0:
        return t.argmax(dim=dim)
    ...
    def forward(self, x, svq_temp: Union[float, None] = None):
        ...
        if self.training:
            ...
            if self.orthogonal_reg_weight > 0:
                ...
                vq_loss["loss"] = (
                    vq_loss["loss"] + orthogonal_reg_loss * self.orthogonal_reg_weight
                )
